...
private:
    ...
    // angle
    LONG        m_elevationAngle; // +- 27 degrees
    bool        m_hasElevationAngleChanged;
...
public:
    ...
    LONG getElevationAngle() const;
    void setElevationAngle(LONG elevationAngle);
    int getTotalFrames() const { return m_FramesTotal; }


    static const _FTIMAGEFORMAT DEPTH_BUFFER_FORMAT = FTIMAGEFORMAT_UINT16_D13P3, 
        VIDEO_BUFFER_FORMAT = FTIMAGEFORMAT_UINT8_B8G8R8X8;
